(() => {
  // ../charity/charity/public/js/conf.js
  ...
  accurate.utils.getAge = function(age) {
    ...
    var differenceInMilisecond = today2.valueOf() - birthday.valueOf();
    var year_age = Math.floor(differenceInMilisecond / 31536e6);
    var day_age = Math.floor(differenceInMilisecond % 31536e6 / 864e5);
  ...
  // ../charity/charity/public/js/Hijri.js
  "use strict";
  frappe.provide("accurate.utils");
  accurate.utils.HijriJS = {
    ...
    today: function today() {
      var today2 = new Date();
      return this.gregorianToHijri(today2.getFullYear(), today2.getMonth() + 1, today2.getDate());
    },
    ...
    HDate: function HDate(year, month, day) {
      ...
      this.format = function useFormat(year2, month2, day2, format) {
        if (accurate.utils.HijriJS.vlidateHijri(year2, month2, day2)) {
          var newFormat = format;
          if (newFormat.indexOf("dd") !== -1)
            newFormat = newFormat.replace("dd", day2 < "10" ? "0" + day2 : day2);
          else
            newFormat = newFormat.replace("d", day2);
          if (newFormat.indexOf("mm") !== -1)
            newFormat = newFormat.replace("mm", month2 < "10" ? "0" + month2 : month2);
          else
            newFormat = newFormat.replace("m", month2);
          if (newFormat.indexOf("yyyy") !== -1)
            newFormat = newFormat.replace("yyyy", year2);
          else
            newFormat = newFormat.replace("yy", year2.substr(year2.length - 2, 2));
  ...
  // ../charity/charity/public/js/notification.js
  $(document).on("startup", function() {
    if (!frappe.boot.charity || frappe.get_route()[0] != "")
      return;
    console.log("frappe.boot.charity.expiring_documents :", frappe.boot.charity.expiring_documents);
    var $wrapper = frappe.msgprint("<table class='table table-striped table-hover'><thead><tr><th>" + __("\u0627\u0644\u062A\u0642\u0631\u064A\u0631") + "</th><th>" + __("\u0627\u0644\u0639\u062F\u062F") + "</th></tr></thead><tbody><tr><td><a href='/app/query-report/Files%20without%20request' target='_blank'>\u0645\u0644\u0641\u0627\u062A \u0645\u0636\u0649 \u0639\u0644\u064A\u0647\u0627 \u0633\u0646\u062A\u064A\u0646 \u0628\u062F\u0648\u0646 \u062A\u0642\u062F\u064A\u0645</a>  </td><td>" + frappe.boot.charity.expiring_documents[0].files_without_request + "</td></tr></tbody></table><hr>", "\u062A\u0646\u0628\u064A\u0647\u0627\u062A \u0627\u0644\u062C\u0645\u0639\u064A\u0629").$wrapper;
    $wrapper.find("a").on("click", function() {
      frappe.set_route("Form", $(this).data("parenttype"), $(this).data("parent"));
    });
  });
})();
//# sourceMappingURL=charity.bundle.V6YPNW76.js.map
