(() => {
  ...
  $(document).on("startup", function() {
    ...
    frappe.boot.charity.notification.forEach((row) => {
      rows = +"<tr>" + "<td><a href='" + row.notification_link + "' target='_blank'>" + row.notification_title + "</a>  </td><td>" + row.notification_count + "</td></tr>";
    });
...
//# sourceMappingURL=charity.bundle.BOFFQYCL.js.map
