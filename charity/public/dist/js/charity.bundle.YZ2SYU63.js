(() => {
  ...
  $(document).on("startup", function() {
    ...
    frappe.boot.charity.notification.forEach((row) => {
      ...
      rows = rows + "<tr><td><a href='" + row.notification_link + "' target='_blank'>" + row.notification_title + "</a>  </td><td>" + row.notification_count + "</td></tr>";
    });
    console.log("file html:", rows);
    var $wrapper = frappe.msgprint("<table class='table table-striped table-hover'><thead><tr><th>" + __("\u0627\u0644\u062A\u0642\u0631\u064A\u0631") + "</th><th>" + __("\u0627\u0644\u0639\u062F\u062F") + "</th></tr></thead><tbody>" + rows + "</tbody></table><hr>", "\u062A\u0646\u0628\u064A\u0647\u0627\u062A \u0627\u0644\u062C\u0645\u0639\u064A\u0629").$wrapper;
    $wrapper.find("a").on("click", function() {
      frappe.set_route("Form", $(this).data("parenttype"), $(this).data("parent"));
    });
  });
})();
//# sourceMappingURL=charity.bundle.YZ2SYU63.js.map
